<template>
  <div class="main-layout">
    <nav class="top-navbar">
      <NuxtLink to="/" class="navbar-logo">OttoCares</NuxtLink>
      <div class="navbar-links">
        <NuxtLink class="navbar-link" to="/neu_pflegekraft">New Pflegekraft</NuxtLink>
        <NuxtLink class="navbar-link" to="/carers">Pflegekräfte</NuxtLink>
        <button
          v-if="user && !loadingUser"
          class="navbar-link navbar-signout-btn"
          @click="handleLogout"
        >
          Abmelden
        </button>
